...
public class BuyWhenPricesFallStrategy extends WeeklyTendencyStrategy {

	public BuyWhenPricesFallStrategy(StockMarket stockMarket, BrokersOffice brokersOffice) {
	...
	protected boolean checkTendency(StockMarket stockMarket, String company) throws LackOfDataInDatabaseException {
		...
		return oldPrice.compareTo(actualPrice) > 0;
	}
}
